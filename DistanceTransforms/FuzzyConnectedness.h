//////////////////////////////////////
//FuzzyConnectedness implementation 
//////////////////////////////////////

#ifndef FUZZY_CONNECTEDNESS_H
#define FUZZY_CONNECTEDNESS_H
...
void FuzzyConnectedness(imagetype seeds, imagetype labels, imagetype cost, double* dt, double *segmentation){
  ...
  while(!Q.empty()){
	...
	fval=max(dt[e.index],abs(double(cost[ni])-double(cost[e.index])));
